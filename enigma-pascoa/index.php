...
<head>
    ...
    <meta property="og:image" content="coeio.png"/>
...
<body> 
    ...
    <a href="X" target="_blank"><button id="botao" style="background:#8f00dd;box-shadow:0 5px 0 #590189;border:0;"><i class="fas fa-arrow-alt-circle-right"></i> Iniciar</button></a>
    <br><br><span style="color:#fff">Decipher the power of the dark rabbits! by <a href="https://github.com/leonardocjr/" target="_blank">Leonardo C. Junior</a></span>
</body></html>
